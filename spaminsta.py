...
#this version is fixed and modified by AMMAR99 From ABSD TEAM(Disclaimer : I do not tolerate any harm caused by the misuse of the tool for malicious purposes.)

# Set the expiration date (YYYY, MM, DD)
expiration_date = datetime(2024, 12, 31)  # Example: December 31, 2024

# Check if the current date is past the expiration date
if datetime.now() > expiration_date:
    print("\033[1;32mTool Disabled by Ahmed \033[0m")
    exit()
#YOUR CHANELL URL
import webbrowser
webbrowser.open('https://t.me/brzrashaq1')
...
def starter():
    ...
    if 'logged_in_user' in r1.text:
        ...
        target=input(f"\033[1;36m Target : \033[0m ") #The username Must Be Entered Manually Not Copy & Paste/n t.i
